...
export QT_BIN_DIR=~/src/MARENOL/build32/_deps/qt5-src/bin
...
export QT_BIN_DIR=~/src/MARENOL/build64/_deps/qt5-src/bin
...
> Fix: winecfg -> Drives -> Remove drives with alternative path to MARENOL src (like: E: -> ~/src)
