...
namespace Script
{
    ...
    {
        /// <summary>
        /// Evaluates an expression and returns the result. Analagous to using the Command field in MARENOL.
        ///
        ...
        /// <summary>
        /// Allocates the requested number of bytes from MARENOL's default process heap.
        ///
