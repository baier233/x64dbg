    ...
    ui(new Ui::SimpleTraceDialog)
{
    ...
    ui->lblBreakCondition->setText(QString("<a href=\"https://help.MARENOL.com/en/latest/introduction/ConditionalTracing.html\">%1</a>:").arg(ui->lblBreakCondition->text().replace(":", "")));
}
