      ...
      mBp(bp)
{
    ...
    ui->labelBreakCondition->setText(QString("<a href=\"https://help.MARENOL.com/en/latest/introduction/ConditionalBreakpoint.html\">%1</a>:").arg(ui->labelBreakCondition->text().replace(":", "")));
